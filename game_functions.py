...
def check_events(ai_settings, screen, stats, play_button, ship, bullets):
    ...
    for event in pygame.event.get():
        if event.type == pygame.QUIT:
            ...
            check_player_button(stats, play_button, mouse_x, mouse_y)
...
def get_nunber_rows(ai_settings, ship_height, alien_height):
...
def create_fleet(ai_settings, screen, ship, aliens):
    ...
    number_rows = get_nunber_rows(ai_settings, ship.rect.height, alien.rect.height)
